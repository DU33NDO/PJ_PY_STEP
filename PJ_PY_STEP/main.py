...
class Purchase:
    ...
    def direct_pizza_to_shopping_cart_by_id(self, id_of_target_pizza: int, shopping_cart=shopping_cart):
    ...
    def direct_pizza_to_shopping_cart_by_name(self, name_of_target_pizza: str, shopping_cart=shopping_cart):
        stmt_to_find_pizza_by_id = """
    ...
    def buy_pizza(self, shopping_cart=shopping_cart):
        total_cost_of_shopping_cart = 0
        counter = 0
        for item in self.shopping_cart:
            counter += 1
            total_cost_of_shopping_cart += item
        return f"Поздравляю! Вы успешно заказали {counter} пицц на сумму {total_cost_of_shopping_cart}"
...
user_1 = User()
user_2 = User()
# print(user_1.to_register("1221", "1"))
# print(user_1.to_login("1221", "1"))
print(user_1.to_log_out())

# print(history_1.direct_pizza_to_shopping_cart_by_id(1))
# print(history_1.direct_pizza_to_shopping_cart_by_id(3))
# print(history_1.direct_pizza_to_shopping_cart_by_id(1))
# print(history_1.direct_pizza_to_shopping_cart_by_name("пепперони"))
# print(history_1.buy_pizza())
